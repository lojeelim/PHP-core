...
?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-7 col-sm-7 col-lg-7">       
            ...
            <h2 class="text-center p-2  ">PENDING ITEM</h2>
            <!-- 
        ...
        <table class="table table-striped responsive-table shadow-sm text-center mb-5">
            ...
            <tbody>
        <?php
         $result = $data->display_client_send_gadget($_SESSION['username']);
        ...
        ?>
            <tr>
                ...
                <form action="user-edit-item.php" method="POST">
                <input type="hidden" name="serial" value="<?php echo $row['serial'];?>">
                    <button class="btn btn-primary " name="edit"><i class="fa fa-pen border p-2 rounded shadow"></i></button>
                </form>
